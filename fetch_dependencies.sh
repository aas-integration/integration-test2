...
JARS=(
    "https://github.com/randoop/randoop/releases/download/v4.0.0/randoop-all-4.0.0.jar"
...
if [[ -z "${DAIKONDIR}" ]]; then
    DAIKON_SRC="http://plse.cs.washington.edu/daikon/download/daikon-5.5.14.tar.gz"
